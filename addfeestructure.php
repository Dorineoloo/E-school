...
$textbook_fee= $_POST['textbook_fee'];
$uniform_fee= $_POST['uniform_fee'];
$total=$_POST['total'];  
$sql = "INSERT INTO feestructure (tution_fee,textbook_fee,uniform_fee,total) VALUES('$tution_fee', '$textbook_fee', '$uniform_fee','$total',)";
...
<li><a href="addUser.php"><i class="fa fa-book"></i>Add User</a></li>
    ...
    <form action="addfeestructure.php" method="post">
       <label>Tution:</label><br> 
        <input type="text" name="tution_fee"><br><br>
        <label>textbook:</label><<br>
        <input type="text" name="textbook_fee"><br><br>
        <label>uniform:</label> <br>
        <input type="text" name="uniform_fee"><br><br>
